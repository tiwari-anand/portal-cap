 ...
 * For example: `zip([1, 2], [3, 4, 5, 6])` => `[1, 3, 2, 4, 5, 6]`
...
function zip(left, right) {
    ...
    return longerArr.reduce(function (zipped, _, i) {
        ...
        return __spreadArrays(zipped, currentZipped);
    }, []);
}
exports.zip = zip;
/**
...
function partition(arr, condition) {
    return arr.reduce(function (_a, item) {
        ...
        return condition(item)
            ? [__spreadArrays(conditionTrue, [item]), conditionFalse]
            : [conditionTrue, __spreadArrays(conditionFalse, [item])];
    }, [[], []]);
}
