...
export declare function getAuthHeaders(destination: Destination, customHeaders?: Record<string, any>): Promise<Record<string, string>>;
/**
 * @deprecated Since v1.20.0. Use [[buildAuthorizationHeaders]] instead.
...
export declare function buildAuthorizationHeaders(destination: Destination): Promise<Record<string, string>>;
