 ...
 */
export declare function clientCredentialsGrant(tokenServiceUrlOrXsuaaServiceCerednetials: string | XsuaaServiceCredentials, clientCredentials: ClientCredentials, options?: ResilienceOptions, customBody?: Record<string, any>): Promise<ClientCredentialsResponse>;
/**
 ...
 */
export declare function userTokenGrant(tokenServiceUrlOrXsuaaServiceCerednetials: string | XsuaaServiceCredentials, userJwt: string, clientId: string, options?: ResilienceOptions): Promise<UserTokenResponse>;
/**
 ...
 * @returns A promise resolving to the response of the XSUAA service.
 */
export declare function refreshTokenGrant(tokenServiceUrlOrXsuaaServiceCerednetials: string | XsuaaServiceCredentials, clientCredentials: ClientCredentials, refreshToken: string, options?: ResilienceOptions): Promise<UserTokenResponse>;
/**
