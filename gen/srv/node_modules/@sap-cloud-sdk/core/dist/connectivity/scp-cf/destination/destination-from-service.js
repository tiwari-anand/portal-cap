...
var DestinationFromServiceRetriever = /** @class */ (function () {
    function DestinationFromServiceRetriever(name, options, decodedUserJwt, providerClientCredentialsToken) {
        this.name = name;
        this.decodedUserJwt = decodedUserJwt;
        this.providerClientCredentialsToken = providerClientCredentialsToken;
        this.options = __assign({}, options);
        this.decodedProviderClientCredentialsToken = jwt_1.decodeJwt(providerClientCredentialsToken);
        this.options.isolationStrategy =
            options.isolationStrategy || cache_1.IsolationStrategy.Tenant;
        this.options.selectionStrategy =
            options.selectionStrategy || destination_selection_strategies_1.subscriberFirst;
    ...
    DestinationFromServiceRetriever.getDestinationFromDestinationService = function (name, options) {
        return __awaiter(this, void 0, void 0, function () {
            var decodedUserJwt, providerToken, da, destinationResult, destination, withProxySetting;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, DestinationFromServiceRetriever.getDecodedUserJwt(options)];
                    case 1:
                        decodedUserJwt = _a.sent();
                        return [4 /*yield*/, DestinationFromServiceRetriever.getProviderClientCredentialsToken(options)];
                    case 2:
                        providerToken = _a.sent();
                        da = new DestinationFromServiceRetriever(name, options, decodedUserJwt, providerToken);
                    ...
                    case 3:
                        ...
                        if (!(destination.authentication === 'OAuth2SAMLBearerAssertion')) return [3 /*break*/, 5];
                        return [4 /*yield*/, da.addOAuthSamlAuth(destination, destinationResult.origin)];
                    case 4:
                        destination = _a.sent();
                        _a.label = 5;
                    case 5:
                        if (!(destination.authentication === 'OAuth2UserTokenExchange')) return [3 /*break*/, 7];
                        return [4 /*yield*/, da.addOAuth2UserTokenExchange(destinationResult.origin)];
                    case 6:
                        destination = _a.sent();
                        _a.label = 7;
                    case 7:
                        if (!(destination.authentication === 'ClientCertificateAuthentication')) return [3 /*break*/, 9];
                        return [4 /*yield*/, da.addClientCertAuth()];
                    case 8:
                        destination = _a.sent();
                        _a.label = 9;
                    case 9: return [4 /*yield*/, da.addProxyConfiguration(destination)];
                    case 10:
    ...
    DestinationFromServiceRetriever.getDecodedUserJwt = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, options.userJwt
                        ? jwt_1.verifyJwt(options.userJwt, options)
                        : options.iss
                            ? { iss: options.iss }
                            : undefined];
            });
    ...
    DestinationFromServiceRetriever.getProviderClientCredentialsToken = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var userJwt, optionsWithoutJwt;
            return __generator(this, function (_a) {
                userJwt = options.userJwt, optionsWithoutJwt = __rest(options, ["userJwt"]);
                return [2 /*return*/, token_accessor_1.serviceToken('destination', optionsWithoutJwt)];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        destinationSearchResult = _a.sent();
                        _a.label = 2;
                    case 2:
                    ...
                    case 4:
                        ...
                        if (destinationSearchResult && destinationSearchResult.fromCache) {
                            logger.info("Successfully retrieved destination from destination service cache for " + destinationSearchResult.origin + " destinations.");
                        }
    ...
    DestinationFromServiceRetriever.prototype.fetchDestinationByToken = function (jwt) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, destination_service_1.fetchDestination(destinationService.credentials.uri, jwt, this.name, this.options)];
            });
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = {};
                        return [4 /*yield*/, token_accessor_1.userApprovedServiceToken(this.options.userJwt, environment_accessor_1.getDestinationService(), this.options)];
                    ...
                    case 3: return [2 /*return*/, (_b.authHeaderJwt = _c.sent(),
                            _b.exchangeHeaderJwt = this.options.userJwt,
                            _b)];
    ...
    DestinationFromServiceRetriever.prototype.addOAuth2UserTokenExchange = function (destinationOrigin) {
        return __awaiter(this, void 0, void 0, function () {
            var token;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    DestinationFromServiceRetriever.prototype.addOAuthSamlAuth = function (destination, destinationOrigin) {
        return __awaiter(this, void 0, void 0, function () {
            var destinationService, token, _a, accessToken;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        destinationService = environment_accessor_1.getDestinationService();
                        if (!destination.systemUser) return [3 /*break*/, 4];
                        if (!(destinationOrigin === 'provider')) return [3 /*break*/, 1];
                        _a = this.providerClientCredentialsToken;
                        return [3 /*break*/, 3];
                    ...
                    case 3:
                        token = _a;
                        logger.debug("System user found on destination. The " + destinationOrigin + " token: " + token + " is used for destination fetching");
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, token_accessor_1.userApprovedServiceToken(this.options.userJwt, destinationService, this.options)];
                    case 5:
                        accessToken = _b.sent();
    ...
    DestinationFromServiceRetriever.prototype.addClientCertAuth = function () {
        return __awaiter(this, void 0, void 0, function () {
            var accessToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, token_accessor_1.serviceToken('destination', __assign({ userJwt: this.decodedUserJwt }, this.options))];
                    case 1:
                        accessToken = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (proxy_util_1.proxyStrategy(destination)) {
                    case proxy_util_1.ProxyStrategy.ON_PREMISE_PROXY:
                        return [2 /*return*/, connectivity_service_1.addProxyConfigurationOnPrem(destination, this.options.userJwt)];
    ...
    DestinationFromServiceRetriever.prototype.updateDestinationCache = function (destination, destinationOrigin) {
        ...
        destination_cache_1.destinationCache.cacheRetrievedDestination(destinationOrigin === 'subscriber'
            ? this.decodedUserJwt
            : this.decodedProviderClientCredentialsToken, destination, this.options.isolationStrategy);
    };
    DestinationFromServiceRetriever.prototype.getProviderDestinationService = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getInstanceAndSubaccountDestinations(this.providerClientCredentialsToken)];
                    case 1:
                        provider = _a.sent();
                        return [4 /*yield*/, this.options.selectionStrategy({
    ...
    DestinationFromServiceRetriever.prototype.getProviderDestinationCache = function () {
        var destination = destination_cache_1.destinationCache.retrieveDestinationFromCache(this.decodedProviderClientCredentialsToken, this.name, this.options.isolationStrategy);
        if (destination) {
    ...
    DestinationFromServiceRetriever.prototype.getSubscriberDestinationCache = function () {
        var destination = destination_cache_1.destinationCache.retrieveDestinationFromCache(this.decodedUserJwt, this.name, this.options.isolationStrategy);
        if (destination) {
            return { destination: destination, fromCache: true, origin: 'subscriber' };
        }
    };
    DestinationFromServiceRetriever.prototype.isProviderAndSubscriberSameTenant = function () {
        return (this.decodedUserJwt &&
            jwt_1.isIdenticalTenant(this.decodedUserJwt, this.decodedProviderClientCredentialsToken));
    };
    ...
    DestinationFromServiceRetriever.prototype.searchProviderAccountForDestination = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, destination || this.getProviderDestinationService()];
            });
        });
    };
    DestinationFromServiceRetriever.prototype.searchSubscriberAccountForDestination = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, destination || this.getSubscriberDestinationService()];
            });
        });
    };
