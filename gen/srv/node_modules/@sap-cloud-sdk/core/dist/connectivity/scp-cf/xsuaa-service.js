 ...
 */
function clientCredentialsGrant(tokenServiceUrlOrXsuaaServiceCerednetials, clientCredentials, options, customBody) {
    ...
    return post(tokenServiceUrlOrXsuaaServiceCerednetials, authHeader, objectToXWwwUrlEncodedBodyString(body), options)
 ...
 */
function userTokenGrant(tokenServiceUrlOrXsuaaServiceCerednetials, userJwt, clientId, options) {
    ...
    return post(tokenServiceUrlOrXsuaaServiceCerednetials, authHeader, body, options)
        .then(function (resp) { return resp.data; })
        .catch(function (error) {
 ...
 * @returns A promise resolving to the response of the XSUAA service.
 */
function refreshTokenGrant(tokenServiceUrlOrXsuaaServiceCerednetials, clientCredentials, refreshToken, options) {
    var authHeader = headerForClientCredentials(clientCredentials);
    var body = objectToXWwwUrlEncodedBodyString({
...
function post(tokenServiceUrlOrXsuaaServiceCerednetials, authHeader, body, options) {
    if (options === void 0) { options = { enableCircuitBreaker: true }; }
    var config = wrapXsuaaPostRequestHeader(authHeader);
    var targetUri = typeof tokenServiceUrlOrXsuaaServiceCerednetials === 'string'
