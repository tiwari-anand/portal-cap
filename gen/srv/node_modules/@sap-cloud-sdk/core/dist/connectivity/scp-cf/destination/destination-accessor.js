...
exports.getDestination = exports.getDestinationOptions = exports.useOrFetchDestination = void 0;
var util_1 = require("@sap-cloud-sdk/util");
var destination_1 = require("./destination");
var destination_service_types_1 = require("./destination-service-types");
var destination_from_env_1 = require("./destination-from-env");
var destination_from_vcap_1 = require("./destination-from-vcap");
var destination_from_service_1 = require("./destination-from-service");
...
function getDestination(name, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, (destination_from_env_1.searchEnvVariablesForDestination(name) ||
                    destination_from_vcap_1.searchServiceBindingForDestination(name) ||
                    destination_from_service_1.getDestinationFromDestinationService(name, options))];
        });
    });
}
