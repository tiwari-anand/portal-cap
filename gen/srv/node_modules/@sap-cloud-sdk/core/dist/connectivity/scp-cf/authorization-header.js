...
var client_credentials_token_1 = require("./client-credentials-token");
...
function headerFromOAuth2ClientCredentialsDestination(destination) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client_credentials_token_1.getOAuth2ClientCredentialsToken(destination).catch(function (error) {
                        throw new util_1.ErrorWithCause('Request for "OAuth2ClientCredentials" authentication access token failed or denied.', error);
                    })];
                case 1:
                    response = _a.sent();
