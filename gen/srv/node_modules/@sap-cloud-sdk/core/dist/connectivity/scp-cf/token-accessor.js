    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, xsuaa_service_1.clientCredentialsGrant(xsuaa, serviceCreds, opts)
                    ...
                    throw new util_1.ErrorWithCause("Fetching an access token for service \"" + resolvedService.label + "\" failed!", error);
                })];
        });
    });
}
...
function userApprovedServiceToken(userJwt, service, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            serviceCreds = environment_accessor_1.extractClientCredentials(resolvedService.credentials);
            return [2 /*return*/, xsuaa_service_1.userTokenGrant(xsuaa, userJwt, serviceCreds.username, opts)
                    ...
                    .catch(function (error) {
                    throw new util_1.ErrorWithCause("Fetching a user approved access token for service \"" + resolvedService.label + "\" failed!", error);
                })];
        });
    });
}
...
function multiTenantXsuaaCredentials(userJwt) {
    ...
    if (userJwt) {
        var decodedJwt = typeof userJwt === 'string' ? jwt_1.decodeJwt(userJwt) : userJwt;
        if (!decodedJwt.iss) {
