...
exports.userFromJwt = exports.userId = exports.userScopes = exports.userEmail = exports.userName = exports.userFamilyName = exports.userGivenName = exports.mappingUserFields = void 0;
...
exports.mappingUserFields = {
    ...
    customAttributes: {
        ...
        extractorFunction: jwt_1.customAttributes
    }
};
/**
...
function userFromJwt(decodedJWT) {
    ...
    return {
        ...
        customAttributes: jwt_1.customAttributes(decodedJWT),
