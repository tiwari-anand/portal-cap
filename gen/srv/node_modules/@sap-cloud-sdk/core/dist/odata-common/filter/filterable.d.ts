 ...
 */
export declare type Filterable<EntityT extends Entity> = Filter<EntityT, FieldType | FieldType[]> | FilterLink<EntityT> | FilterList<EntityT> | FilterLambdaExpression<EntityT, FieldType>;
/**
...
export declare function or<EntityT extends Entity>(...expressions: Filterable<EntityT>[]): FilterList<EntityT>;
export declare function toFilterableList<EntityT extends Entity, LinkedEntityT extends Entity>(filters: (Filterable<EntityT> | OneToManyLink<EntityT, LinkedEntityT>)[]): Filterable<EntityT>[];
