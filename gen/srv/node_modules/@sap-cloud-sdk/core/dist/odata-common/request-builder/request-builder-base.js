...
var MethodRequestBuilder = /** @class */ (function () {
    ...
    MethodRequestBuilder.prototype.build = function (destination, options) {
        var _this = this;
        if (destination) {
            return scp_cf_1.useOrFetchDestination(destination, options)
                .then(function (dest) {
                if (!dest) {
                ...
                throw new util_1.ErrorWithCause(noDestinationErrorMessage(destination), error);
            });
        }
...
function noDestinationErrorMessage(destination) {
    return scp_cf_1.isDestinationNameAndJwt(destination)
