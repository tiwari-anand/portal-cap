...
exports.GetAllRequestBuilderBase = exports.GetAllRequestBuilder = void 0;
var util_1 = require("@sap-cloud-sdk/util");
var count_request_builder_1 = require("../request-builder/count-request-builder");
var get_request_builder_base_1 = require("./get-request-builder-base");
/**
...
var GetAllRequestBuilder = /** @class */ (function (_super) {
     ...
     */
    function GetAllRequestBuilder(entityConstructor, getAllRequestConfig, entityDeserializer, dataAccessor) {
        var _this = _super.call(this, entityConstructor, getAllRequestConfig) || this;
        _this.entityDeserializer = entityDeserializer;
        _this.dataAccessor = dataAccessor;
        return _this;
    }
    GetAllRequestBuilder.prototype.select = function (first) {
        var rest = [];
    ...
    GetAllRequestBuilder.prototype.orderBy = function (first) {
        var rest = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            rest[_i - 1] = arguments[_i];
        }
     ...
     */
    GetAllRequestBuilder.prototype.top = function (top) {
     ...
     * @returns The request builder itself, to facilitate method chaining
     */
    GetAllRequestBuilder.prototype.skip = function (skip) {
     ...
     */
    GetAllRequestBuilder.prototype.count = function () {
     ...
     */
    GetAllRequestBuilder.prototype.execute = function (destination, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.build(destination, options)
                        ...
                        return _this.dataAccessor
                            .getCollectionResult(response.data)
                            .map(function (json) {
                            return _this.entityDeserializer.deserializeEntity(json, _this._entityConstructor, response.headers);
                        });
                    })];
            });
        });
...
}(get_request_builder_base_1.GetRequestBuilder));
exports.GetAllRequestBuilder = GetAllRequestBuilder;
exports.GetAllRequestBuilderBase = GetAllRequestBuilder;
