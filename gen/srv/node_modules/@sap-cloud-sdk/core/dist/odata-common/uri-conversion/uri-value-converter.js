...
exports.uriConvertersCommon = {
    'Edm.Binary': function (value) { return "X'" + value + "'"; },
    ...
    'Edm.Int64': function (value) { return value + "L"; },
    'Edm.Double': function (value) { return (isInfOrNan(value) ? value : value + "D"); },
    'Edm.Single': function (value) { return (isInfOrNan(value) ? value : value + "F"); },
    'Edm.Float': function (value) { return (isInfOrNan(value) ? value : value + "F"); },
