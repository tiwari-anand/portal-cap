...
function warnIfNavigation(request, entity, entityConstructor) {
    var setNavigationsProperties = Object.keys(entity).filter(function (key) {
        return !util_1.isNullish(entity[key]) && odata_common_1.isNavigationProperty(key, entityConstructor);
    });
...
function removeNavPropsAndComplexTypes(body) {
    return odata_common_1.removePropertyOnCondition(function (_a) {
