...
exports.ODataBatchRequestBuilderV4 = exports.ODataBatchRequestBuilder = void 0;
var util_1 = require("@sap-cloud-sdk/util");
var batch_response_parser_1 = require("../odata-common/request-builder/batch/batch-response-parser");
var batch_request_builder_1 = require("../odata-common/request-builder/batch/batch-request-builder");
var batch_response_deserializer_1 = require("../odata-common/request-builder/batch/batch-response-deserializer");
...
var ODataBatchRequestBuilder = /** @class */ (function (_super) {
    ...
    function ODataBatchRequestBuilder() {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.build(destination, options)
                        ...
                        .then(function (response) { return batch_response_parser_1.parseBatchResponse(response); })
                        .then(function (parsedResponse) {
                        return batch_response_deserializer_1.deserializeBatchResponse(parsedResponse, _this.entityToConstructorMap, response_data_accessor_1.responseDataAccessor, entity_deserializer_1.entityDeserializer);
                    })
...
}(batch_request_builder_1.BatchRequestBuilder));
exports.ODataBatchRequestBuilder = ODataBatchRequestBuilder;
exports.ODataBatchRequestBuilderV4 = ODataBatchRequestBuilder;
