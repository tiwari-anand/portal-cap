...
var logger = util_1.createLogger('usage-analytics');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    configPath = config_1.findConfigPath();
                    config = configPath && JSON.parse(fs_1.readFileSync(configPath, 'utf8'));
                    if (!(config === null || config === void 0 ? void 0 : config.enabled)) return [3 /*break*/, 3];
                    config = config_1.enforceValidConfig(config);
                    return [4 /*yield*/, analytics_data_1.getAnalyticsData(config)];
                case 1:
                    data = _a.sent();
