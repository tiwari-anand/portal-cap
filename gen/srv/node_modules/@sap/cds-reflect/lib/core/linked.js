...
const _resolve = (x,defs) => defs[x] || _builtin[x] || _hana(x) || (defs[x] = _unresolved(x))
...
const _hana = (x) => x.startsWith('cds.hana.') && any
const _unresolved = (x,p=entity) => ({name:x, __proto__:p, _unresolved:true})
