...
// REVISIT: finalize name
const LOG = (cds.log || cds.debug)('RemoteService')

const sdkUtils = require('@sap-cloud-sdk/util')

// disable sdk logger if not in debug mode
if ((!cds.log && !LOG) || (cds.log && !LOG._debug)) {
...
class RestService extends cds.Service {
  init () {
    ...
    this.on('*', async (req, next) => {
      ...
      // REVISIT: brute force deletion of host and authorization header
