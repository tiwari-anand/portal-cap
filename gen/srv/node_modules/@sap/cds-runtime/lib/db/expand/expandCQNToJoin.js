...
class JoinCQNFromExpanded {
  ...
  _skip (targetEntity) {
    ...
    return (
      targetEntity && targetEntity['@cds.persistence.skip'] && targetEntity['@cds.persistence.skip'] !== 'if-unused'
    )
  }
  ...
  _isStructured (elements, refName) {
    for (const element in elements) {
      if (elements[element].elements && refName.startsWith(elements[element].name + '_')) {
        return true
      }
    }
  }
