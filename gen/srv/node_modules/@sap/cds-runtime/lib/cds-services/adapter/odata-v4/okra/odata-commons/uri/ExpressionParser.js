...
class ExpressionParser {
   ...
   * @private
   */
  _parsePrimitive (primitiveTokenKind) /* NOSONAR */ {
   ...
   * @private
   */
  _parseMemberExpression (lastTokenKind, pathSegments, lastResource, allowTypeCast) /* NOSONAR */ {
   ...
   * @private
   */
  _parsePropertyPathExpr (pathSegments, lastResource) /* NOSONAR */ {
   ...
   * @private
   */
  _parseFunctionRest (pathSegments, func, parameters) /* NOSONAR */ {
   ...
   * @private
   */
  _getAddSubTypeAndCheckLeftAndRight (left, right, isSub) /* NOSONAR */ {
    this.checkNoCollection(left)
    this.checkNoCollection(right)
    const leftType = this._getType(left)
    const rightType = this._getType(right)
   ...
   * @private
   */
  _getModResultType (leftType, rightType) /* NOSONAR */ {
