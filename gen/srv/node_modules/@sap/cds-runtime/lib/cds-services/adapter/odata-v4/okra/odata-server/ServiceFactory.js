    ...
    return (
      new Service(edmProvider)
        ...
        .format(
          RepresentationKinds.BATCH,
          ContentTypes.JSON,
          SerializerFactory.batch,
          SerializerFactory.checkJsonParameters
        )
        .format(
          RepresentationKinds.ENTITY,
          ContentTypes.JSON,
          SerializerFactory.resourceEntity,
          SerializerFactory.checkJsonParameters
        )
        .format(
          RepresentationKinds.ENTITY_COLLECTION,
          ContentTypes.JSON,
          SerializerFactory.resourceEntityCollection,
          SerializerFactory.checkJsonParameters
        )
        .format(
          RepresentationKinds.PRIMITIVE,
          ContentTypes.JSON,
          SerializerFactory.resourcePrimitive,
          SerializerFactory.checkJsonParameters
        )
        .format(
          RepresentationKinds.PRIMITIVE_COLLECTION,
          ContentTypes.JSON,
          SerializerFactory.resourcePrimitiveCollection,
          SerializerFactory.checkJsonParameters
        )
        .format(
          RepresentationKinds.COMPLEX,
          ContentTypes.JSON,
          SerializerFactory.resourceComplex,
          SerializerFactory.checkJsonParameters
        )
        .format(
          RepresentationKinds.COMPLEX_COLLECTION,
          ContentTypes.JSON,
          SerializerFactory.resourceComplexCollection,
          SerializerFactory.checkJsonParameters
        )
        .format(
          RepresentationKinds.REFERENCE,
          ContentTypes.JSON,
          SerializerFactory.resourceReference,
          SerializerFactory.checkJsonParameters
        )
        .format(
          RepresentationKinds.REFERENCE_COLLECTION,
          ContentTypes.JSON,
          SerializerFactory.resourceReferenceCollection,
          SerializerFactory.checkJsonParameters
        )
        ...
        .format(RepresentationKinds.ERROR, ContentTypes.XML, (error, response, next) =>
          next(null, new ErrorXmlSerializer(error).serialize())
        )
        .format(
