...
class ResponseHeaderSetter {
  ...
  setContentTypeHeader (overwrite = false) {
    this._logger.path('Entering ResponseHeaderSetter.setContentTypeHeader()...')
  ...
  setLocationHeader (overwrite = false) {
    this._logger.path('Entering ResponseHeaderSetter.setLocationHeader()...')
  ...
  setOdataEntityIdHeader (overwrite = false) {
    this._logger.path('Entering ResponseHeaderSetter.setOdataEntityIdHeader()...')
  ...
  setEtagHeader (overwrite = false) {
    this._logger.path('Entering ResponseHeaderSetter.setEtagHeader()...')
  ...
  setHeader (headerName, headerValue, overwrite = false) {
    this._logger.path('Entering ResponseHeaderSetter.setHeader()...')
