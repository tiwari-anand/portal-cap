...
class ContextURLFactory {
   ...
   */
  createContextURL (uriInfo, expand, representationKind, providedKeyMap = new Map(), edm) /* NOSONAR */ {
   ...
   * @private
   */
  _parseSegments (pathSegments, keyMap, edm) /* NOSONAR */ {
   ...
   * @private
   */
  _buildSelect (select, expand, type, isKeyRequired) /* NOSONAR */ {
    let value = []
   ...
   * @private
   */
  _buildExpand (expand, type, isKeyRequired) /* NOSONAR */ {
    let result = []
