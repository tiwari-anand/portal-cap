...
class ResourcePathParser {
   ...
   * @private
   */
  _parseCollectionNavPath (uriPathSegments, currentResource, tokenizer) /* NOSONAR */ {
    if (tokenizer.next(TokenKind.OPEN)) {
   ...
   * @private
   */
  _parseBoundFunction (uriPathSegments, tokenizer, fqn, bindingParamTypeFqn, previousIsCollection) /* NOSONAR */ {
    let result = []
   ...
   * @private
   */
  _parseProperty (uriPathSegments, prevResource, tokenizer) /* NOSONAR */ {
    let propertyName = tokenizer.getText()
