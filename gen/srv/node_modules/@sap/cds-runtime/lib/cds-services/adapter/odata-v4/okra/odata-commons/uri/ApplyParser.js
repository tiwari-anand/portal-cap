...
class ApplyParser {
   ...
   * @private
   */
  _parseTrafo (referencedType) /* NOSONAR */ {
   ...
   * @private
   */
  _parseAggregateExpr (referencedType) /* NOSONAR */ {
   ...
   * @private
   */
  _parseConcatTrafo (referencedType) /* NOSONAR */ {
   ...
   * @private
   */
  _parsePathPrefix (referencedType) /* NOSONAR */ {
    let pathSegments = []
    let type = referencedType
    if (this._tokenizer.next(TokenKind.QualifiedName)) {
