...
class RequestValidator {
  ...
  validateDebugOption (queryOptions) {
    this._logger.path('Entering RequestValidator.validateDebugOption()...')
   ...
   */
  validateQueryOptions (queryOptions, uriInfo) /* NOSONAR */ {
    this._logger.path('Entering RequestValidator.validateQueryOptions()...')
    ...
    for (const queryOptionName of Object.keys(queryOptions)) {
   ...
   * @throws {UriSyntaxError} thrown if the validation fails
   */
  validateQueryOptionsForNonGetHttpMethod (queryOptions, method, uriInfo) /* NOSONAR */ {
    ...
    for (const name of Object.keys(queryOptions)) {
  ...
  validateVersion (version, headers) {
    this._logger.path('Entering RequestValidator.validateVersion()...')
  ...
  validatePreferences (preferences, httpMethod, pathSegments) {
    this._logger.path('Entering RequestValidator.validatePreferences()...')
  ...
  checkForForbiddenQueryOptions (queryOptions) {
    if (queryOptions) {
      for (const queryOptionsName of Object.keys(queryOptions)) {
  ...
  validateOperationOnResource (request) {
    this._logger.path('Entering RequestValidator.validateOperationOnResource()...')
