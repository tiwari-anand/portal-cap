...
class ResponseContentNegotiator {
   ...
   */
  negotiate (formatManager, inRequest, uriInfo) /* NOSONAR */ {
   ...
   */
  negotiateContentType (formatManager, representationKind, acceptHeader) /* NOSONAR */ {
   ...
   */
  negotiateCharset (contentTypeInfo, acceptCharset, acceptFromFormat) /* NOSONAR */ {
