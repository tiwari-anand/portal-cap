...
const RepresentationKind = require('../../odata-commons').format.RepresentationKind.Kinds
...
class DebugDeserializingCommand extends Command {
  ...
  execute (next) {
    ...
    if (
      this._request.getContract().getRepresentationKind() !== RepresentationKind.NO_CONTENT &&
      ...
      binaryParserFunction(this._request, (error, body) => {
