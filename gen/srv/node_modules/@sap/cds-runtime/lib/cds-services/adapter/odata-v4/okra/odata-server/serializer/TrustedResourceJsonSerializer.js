...
class TrustedResourceJsonSerializer {
   ...
   * @private
   */
  _serializeStructure (result, type, data, expandItems, odataPath, structurePath) /* NOSONAR */ {
   ...
   * @private
   */
  _serializePropertyValue (property, propertyValue, expandItems, odataPath, structurePath) /* NOSONAR */ {
