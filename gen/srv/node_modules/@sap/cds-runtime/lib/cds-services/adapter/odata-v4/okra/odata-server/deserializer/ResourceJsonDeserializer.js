...
class ResourceJsonDeserializer {
   ...
   * @throws {DeserializationError} if provided data can not be deserialized
   */
  deserializeActionParameters (edmAction, value) /* NOSONAR */ {
    let data
    let result = {}
   ...
   * @private
   */
  _deserializeAnnotation (edmType, outerValue, name, value, isNested, isDelta, additionalInformation) /* NOSONAR */ {
