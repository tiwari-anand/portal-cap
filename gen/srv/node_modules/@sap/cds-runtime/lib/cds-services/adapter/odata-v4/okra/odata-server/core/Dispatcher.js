...
class Dispatcher {
  ...
  _handle (request, response, componentManager, handlerName) {
    ...
    const performanceMonitor = this._performanceMonitor
      .getChild('Handler dispatching')
      .createChild('Process handler ' + handlerName)
      .start()

    return new Promise((resolve, reject) => {
      handler(request, response, (err, resultData, resultOptions) => {
