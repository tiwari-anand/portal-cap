...
class PrimitiveValueDecoder {
   ...
   * @private
   */
  _decodeV2Json (propertyOrReturnType, jsonValue) /* NOSONAR */ {
   ...
   * @private
   */
  _decodeV4Json (propertyOrReturnType, value) /* NOSONAR */ {
   ...
   * @private
   */
  _decodeV4Text (propertyOrReturnType, valueString) /* NOSONAR */ {
    let type = propertyOrReturnType.getType()
    if (type.getKind() === EdmTypeKind.DEFINITION) type = type.getUnderlyingType()
