...
class ResourceJsonSerializer {
   ...
   * @private
   */
  _validateAnnotationValue (annotation, value) /* NOSONAR */ {
   ...
   * @private
   */
  _serializeStructuralProperties /* NOSONAR */ (
    type,
    entitySetOrSingleton,
    data,
    odataPath,
   ...
   * @private
   */
  _serializeNavigationProperties /* NOSONAR */ (
    type,
    entitySetOrSingleton,
    data,
    odataPath,
   ...
   * @private
   */
  _getAssertAdditionalProperties (data, type, selectedPaths) /* NOSONAR */ {
    let extraProperties = {}
