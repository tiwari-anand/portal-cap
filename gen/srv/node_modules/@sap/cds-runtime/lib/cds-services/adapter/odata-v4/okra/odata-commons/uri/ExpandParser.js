...
class ExpandParser {
   ...
   * @private
   */
  _parseItem (tokenizer, referencedType, crossjoinEntitySets, aliases) /* NOSONAR */ {
   ...
   * @throws {UriQueryOptionSemanticError}
   */
  parseExpandPath (tokenizer, referencedType, crossjoinEntitySets) /* NOSONAR */ {
    let path = []
