...
module.exports = exports = function cds_resolve (model, o={}) { // NOSONAR
  ...
  if (model === '*') return _resolve_all['*'] || _resolve_all(this,o)
...
function _paths (dir) {
  ...
  return _paths[dir] = { paths, cached:{} }
}
