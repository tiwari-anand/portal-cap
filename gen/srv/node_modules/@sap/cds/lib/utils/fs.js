...
module.exports = {
    ...fs, fs, path, mkdirp, rimraf, rimrafSync, isdir, isfile, find, copy, resolve,
    get node_util(){ return this._util || (this._util = require('util')) },
    get inspect() { return this.node_util.inspect },
    get promisify() { return this.node_util.promisify },
    uuid
}
