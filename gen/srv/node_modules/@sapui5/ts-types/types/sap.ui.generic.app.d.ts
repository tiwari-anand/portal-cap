      ...
      namespace app {
          ...
          namespace service {
            ...
            class NavError extends sap.ui.base.Object {
              ...
              static extend<T extends Record<string, unknown>>(
                 ...
                 */
                oClassInfo?: T &
                  ThisType<T & sap.ui.generic.app.navigation.service.NavError>,
                /**
            ...
            class NavigationHandler extends sap.ui.base.Object {
              ...
              static extend<T extends Record<string, unknown>>(
                ...
                oClassInfo?: T &
                  ThisType<
                    T & sap.ui.generic.app.navigation.service.NavigationHandler
                  >,
                /**
                 * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
                 */
            ...
            class SelectionVariant extends sap.ui.base.Object {
              ...
              static extend<T extends Record<string, unknown>>(
                ...
                oClassInfo?: T &
                  ThisType<
                    T & sap.ui.generic.app.navigation.service.SelectionVariant
                  >,
                /**
                 * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
                 */
        ...
        namespace transaction {
          ...
          class DraftContext extends sap.ui.base.Object {
            ...
            static extend<T extends Record<string, unknown>>(
               ...
               */
              oClassInfo?: T &
                ThisType<T & sap.ui.generic.app.transaction.DraftContext>,
              /**
               * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
               */
              FNMetaImpl?: Function
          ...
          class DraftController extends sap.ui.generic.app.transaction
            ...
            static extend<T extends Record<string, unknown>>(
               ...
               */
              oClassInfo?: T &
                ThisType<T & sap.ui.generic.app.transaction.DraftController>,
              /**
               * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
               */
              FNMetaImpl?: Function
          ...
          class TransactionController extends sap.ui.generic.app.transaction
            ...
            static extend<T extends Record<string, unknown>>(
              ...
              oClassInfo?: T &
                ThisType<
                  T & sap.ui.generic.app.transaction.TransactionController
                >,
              /**
               * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
               */
        ...
        class ApplicationController extends sap.ui.generic.app.transaction
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             */
            oClassInfo?: T &
              ThisType<T & sap.ui.generic.app.ApplicationController>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
             */
            FNMetaImpl?: Function
