      ...
      namespace fiori2 {
        ...
        class Renderer extends sap.ui.core.UIComponent {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             */
            oClassInfo?: T & ThisType<T & sap.ushell.renderers.fiori2.Renderer>,
            /**
 ...
 */
        ...
        namespace controls {
          ...
          class PictureTile extends sap.m.CustomTile {
            ...
            static extend<T extends Record<string, unknown>>(
              ...
              oClassInfo?: T &
                ThisType<
                  T & sap.ushell.components.factsheet.controls.PictureTile
                >,
              /**
               * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
               */
          ...
          class PictureViewer extends sap.m.TileContainer {
            ...
            static extend<T extends Record<string, unknown>>(
              ...
              oClassInfo?: T &
                ThisType<
                  T & sap.ushell.components.factsheet.controls.PictureViewer
                >,
              /**
               * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
               */
          ...
          class PictureViewerItem extends sap.ui.core.Control {
            ...
            static extend<T extends Record<string, unknown>>(
              ...
              oClassInfo?: T &
                ThisType<
                  T & sap.ushell.components.factsheet.controls.PictureViewerItem
                >,
              /**
               * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
               */
    ...
    namespace ui {
      namespace appfinder {
        ...
        class AppBox extends sap.ui.core.Control {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             * Object literal with information about the class
             */
            oClassInfo?: T & ThisType<T & sap.ushell.ui.appfinder.AppBox>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
             */
            FNMetaImpl?: Function
      ...
      namespace footerbar {
        ...
        class AddBookmarkButton extends sap.m.Button {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             */
            oClassInfo?: T &
              ThisType<T & sap.ushell.ui.footerbar.AddBookmarkButton>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
             */
            FNMetaImpl?: Function
      ...
      namespace launchpad {
        ...
        interface $ShortcutsHelpContainerSettings
          extends sap.ui.core.$ControlSettings {
        ...
        class GridContainer extends sap.ui.core.Control {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             */
            oClassInfo?: T &
              ThisType<T & sap.ushell.ui.launchpad.GridContainer>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
             */
            FNMetaImpl?: Function
        ...
        class ShortcutsHelpContainer extends sap.ui.core.Control {
          ...
          constructor(
             ...
             * initial settings for the new control
             */
            mSettings?: $ShortcutsHelpContainerSettings
          );
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             */
            oClassInfo?: T &
              ThisType<T & sap.ushell.ui.launchpad.ShortcutsHelpContainer>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
             */
            FNMetaImpl?: Function
      ...
      namespace shell {
        ...
        class ToolAreaItem extends sap.ui.core.Control {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             * Object literal with information about the class
             */
            oClassInfo?: T & ThisType<T & sap.ushell.ui.shell.ToolAreaItem>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
             */
            FNMetaImpl?: Function
 ...
 */
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: T & ThisType<T & sap.ushell.ui5service.ShellUIService>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
           */
          FNMetaImpl?: Function
