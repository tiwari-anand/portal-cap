  ...
  namespace makit {
    ...
    class Axis extends sap.ui.core.Element {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         */
        oClassInfo?: T & ThisType<T & sap.makit.Axis>,
        /**
    ...
    class Category extends sap.ui.core.Element {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.makit.Category>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
    ...
    class CategoryAxis extends sap.makit.Axis {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.makit.CategoryAxis>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
    ...
    class Chart extends sap.ui.core.Control {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.makit.Chart>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
    ...
    class Column extends sap.ui.core.Element {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.makit.Column>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
    ...
    class CombinationChart extends sap.ui.core.Control {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.makit.CombinationChart>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
    ...
    class Layer extends sap.ui.core.Element {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.makit.Layer>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
    ...
    class MakitLib extends sap.ui.core.Element {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.makit.MakitLib>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
    ...
    class Row extends sap.ui.core.Element {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.makit.Row>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
    ...
    class Series extends sap.ui.core.Element {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.makit.Series>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
    ...
    class Value extends sap.ui.core.Element {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.makit.Value>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
    ...
    class ValueAxis extends sap.makit.Axis {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.makit.ValueAxis>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
    ...
    class ValueBubble extends sap.ui.core.Element {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.makit.ValueBubble>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
