        ...
        namespace feed {
          namespace dialog {
            ...
            class Component extends sap.ui.core.UIComponent {
              ...
              static extend<T extends Record<string, unknown>>(
                ...
                oClassInfo?: T &
                  ThisType<
                    T & sap.collaboration.components.fiori.feed.dialog.Component
                  >,
                /**
          ...
          class Component extends sap.ui.core.UIComponent {
            ...
            static extend<T extends Record<string, unknown>>(
               ...
               */
              oClassInfo?: T &
                ThisType<T & sap.collaboration.components.fiori.feed.Component>,
              /**
               * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
               */
              FNMetaImpl?: Function
        ...
        namespace notification {
          ...
          class Component extends sap.ui.core.UIComponent {
            ...
            static extend<T extends Record<string, unknown>>(
              ...
              oClassInfo?: T &
                ThisType<
                  T & sap.collaboration.components.fiori.notification.Component
                >,
              /**
               * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
               */
        ...
        namespace sharing {
          ...
          class Component extends sap.ui.core.UIComponent {
            ...
            static extend<T extends Record<string, unknown>>(
              ...
              oClassInfo?: T &
                ThisType<
                  T & sap.collaboration.components.fiori.sharing.Component
                >,
              /**
               * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
               */
      ...
      namespace socialprofile {
        ...
        class Component extends sap.ui.core.UIComponent {
          ...
          static extend<T extends Record<string, unknown>>(
            ...
            oClassInfo?: T &
              ThisType<
                T & sap.collaboration.components.socialprofile.Component
              >,
            /**
             * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
             */
      ...
      namespace socialtimeline {
        ...
        class Component extends sap.ui.core.UIComponent {
          ...
          static extend<T extends Record<string, unknown>>(
            ...
            oClassInfo?: T &
              ThisType<
                T & sap.collaboration.components.socialtimeline.Component
              >,
            /**
             * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
             */
