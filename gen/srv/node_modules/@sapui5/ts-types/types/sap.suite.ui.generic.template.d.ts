        ...
        namespace template {
          namespace AnalyticalListPage {
            ...
            namespace controllerFrameworkExtensions {
              ...
              /**
               * This method can be used to perform conditional navigation from different rows of the SmartTable by choosing
               * the target app based on the context available in the selected table record.
               */
              function onListNavigationExtension(
                /**
                 * The press event fired when navigating from a row in the SmartTable.
                 */
                oEvent: sap.ui.base.Event
              ): void;
              /**
          ...
          namespace extensionAPI {
            ...
            class NavigationController extends sap.ui.base.Object {
              ...
              navigateInternal(
                /**
                 * The target context for the navigation. If the parameter is faulty (and oNavigationData does not specify
                 * a route itself) the root page of the app is considered to be the target of the application.
                 */
                vContext: sap.ui.model.Context | String,
                /**
          ...
          namespace ListReport {
            ...
            namespace controllerFrameworkExtensions {
              ...
              /**/
              function onListNavigationExtension(): void;
              /**/
