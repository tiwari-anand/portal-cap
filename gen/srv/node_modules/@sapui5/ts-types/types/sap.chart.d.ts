  ...
  namespace chart {
    ...
    namespace data {
      ...
      class Dimension extends sap.ui.core.Element {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           */
          oClassInfo?: T & ThisType<T & sap.chart.data.Dimension>,
          /**
      ...
      class HierarchyDimension extends sap.chart.data.Dimension {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: T & ThisType<T & sap.chart.data.HierarchyDimension>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
           */
          FNMetaImpl?: Function
      ...
      class Measure extends sap.ui.core.Element {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: T & ThisType<T & sap.chart.data.Measure>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
           */
          FNMetaImpl?: Function
      ...
      class TimeDimension extends sap.chart.data.Dimension {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: T & ThisType<T & sap.chart.data.TimeDimension>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
           */
          FNMetaImpl?: Function
    ...
    class Chart extends sap.viz.ui5.controls.common.BaseControl {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: T & ThisType<T & sap.chart.Chart>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
         */
        FNMetaImpl?: Function
