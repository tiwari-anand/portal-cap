...
declare namespace sap {
  ...
  namespace f {
    ...
    interface $AvatarSettings extends sap.ui.core.$ControlSettings {
       ...
       * the Theme Designer.
       */
      backgroundColor?: sap.f.AvatarColor;
    ...
    class Avatar extends sap.ui.core.Control {
      ...
      setBackgroundColor(
         ...
         */
        sBackgroundColor: sap.f.AvatarColor
      ): sap.f.Avatar;
      /**
     ...
     *
     * **Note:** If the `Random` value is assigned, a random color is chosen from the other options (Accent1
     * to Accent10).
     */
    enum AvatarColor {
      /**
