    ...
    namespace ui {
      namespace services {
        ...
        class AstExpressionLanguage extends Element {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             */
            oClassInfo?: T &
              ThisType<T & sap.rules.ui.services.AstExpressionLanguage>,
            /**
        ...
        class ExpressionLanguage extends Element {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             */
            oClassInfo?: T &
              ThisType<T & sap.rules.ui.services.ExpressionLanguage>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
             */
            FNMetaImpl?: Function
      ...
      class DecisionTableConfiguration extends sap.ui.core.Element {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           */
          oClassInfo?: T &
            ThisType<T & sap.rules.ui.DecisionTableConfiguration>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
           */
          FNMetaImpl?: Function
      ...
      class RuleBuilder extends sap.ui.core.Control {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: T & ThisType<T & sap.rules.ui.RuleBuilder>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
           */
          FNMetaImpl?: Function
      ...
      class TextRuleConfiguration extends sap.ui.core.Element {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: T & ThisType<T & sap.rules.ui.TextRuleConfiguration>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to `sap.ui.core.ElementMetadata`
           */
          FNMetaImpl?: Function
